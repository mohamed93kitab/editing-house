...
import 'package:editing_house/screens/auction_products.dart';
import 'package:editing_house/screens/change_language.dart';
import 'package:editing_house/screens/digital_products.dart';
...
import 'package:editing_house/screens/whole_sale_products.dart';
...
import 'package:editing_house/screens/profile_edit.dart';
import 'package:editing_house/screens/address.dart';
import 'package:editing_house/screens/order_list.dart';
import 'package:editing_house/screens/club_point.dart';
import 'package:editing_house/screens/refund_request.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Widget buildSettingAndAddonsHorizontalMenu() {
    return Container(
      ...
      width: DeviceInfo(context).width,
      decoration: BoxDecorations.buildBoxDecoration_1(radius: 12),
      child: Container(
        ...
        child: Wrap(
          ...
          children: [
            ...
            Container(
              // color: Colors.orange,
              width: DeviceInfo(context).width / 4.5,
              child: InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return OrderList();
  ...
  Widget buildCountersRowItem(String counter, String title) {
    return Container(
      ...
      width: DeviceInfo(context).width / 3.6,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12),
        color: MyTheme.white,
      ),

...
import 'package:editing_house/ui_elements/shop_square_card.dart';
import 'package:editing_house/ui_elements/brand_square_card.dart';
...
import 'package:editing_house/repositories/brand_repository.dart';
import 'package:editing_house/repositories/shop_repository.dart';
...
import 'package:editing_house/repositories/search_repository.dart';
        ...
        Container(
          ...
          child: new DropdownButton<WhichFilter>(
            icon: Padding(
              ...
              child: Icon(Icons.expand_more, color: Colors.black54, size: 14,),
            ),
            hint: Text(
                  ...
                  children: [
                   ...
                   //   color: Color.fromRGBO(52, 168, 83, 1),
                      child: Container(
                        ...
                        child: Text(
                        AppLocalizations.of(context).common_apply_in_all_lower,
                        style: TextStyle(color: Colors.white),
                      ),
                      ),
                      onPressed: () {
            ...
            children: [
              ...
              GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisSpacing: 14,
                    childAspectRatio: .76),
                padding: EdgeInsets.only(top:20,bottom:10,left:12,right:12),
                physics: NeverScrollableScrollPhysics(),
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  // 3

...
import 'package:editing_house/repositories/language_repository.dart';
...
class _ChangeLanguageState extends State<ChangeLanguage> {
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        "${AppLocalizations.of(context).change_language_change_language} - (${app_mobile_language.$})",
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            "${_list[index].name} - ${_list[index].mobile_app_code}",

...
import 'package:editing_house/data_model/product_details_response.dart';
import 'package:editing_house/data_model/variant_response.dart';
...
class ProductRepository {
  ...
  Future<ProductMiniResponse> getOfferProducts({page = 1}) async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/products/offers?page=${page}");
    final response = await http.get(url, headers: {
      "App-Language": app_language.$,
    });
  ...
  Future<ProductMiniResponse> getNewArrivalProducts({page = 1}) async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/products/new-arrival?page=${page}");
    final response = await http.get(url, headers: {
      "App-Language": app_language.$,
    });
    print('====================='+response.body.toString());

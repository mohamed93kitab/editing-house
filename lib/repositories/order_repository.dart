...
import 'package:editing_house/data_model/order_mini_response.dart';
import 'package:editing_house/data_model/order_detail_response.dart';
import 'package:editing_house/data_model/order_item_response.dart';
...
class OrderRepository {
  Future<OrderMiniResponse> getOrderList(
    ...
    Uri url = Uri.parse("${AppConfig.BASE_URL}/purchase-history" +
        "?page=${page}&payment_status=${payment_status}&delivery_status=${delivery_status}&user_id=${user_id.$}");
